...
class Wpzoom_Feature_Posts extends WP_Widget {
    ...
    function widget( $args, $instance ) {
        ...
        if ( $two_columns ) {
            echo '<ul class="feature-posts-list wpz-grid-2cols">';
        } else {
    ...
    function form( $instance ) {
        ...
        <p>
            <input class="checkbox" type="checkbox" <?php checked( $instance['two_columns'] ); ?> id="<?php echo $this->get_field_id( 'two_columns' ); ?>" name="<?php echo $this->get_field_name( 'two_columns' ); ?>" />
            <label for="<?php echo $this->get_field_id( 'two_columns' ); ?>"><?php esc_html_e( 'Display posts in 2 columns?', 'wpzoom' ); ?></label>
        </p>
        ...
        <p class="description"><?php _e('Recommended size for 2 columns in portrait orientation is: <strong>170x230px</strong>.', 'wpzoom'); ?></p>
