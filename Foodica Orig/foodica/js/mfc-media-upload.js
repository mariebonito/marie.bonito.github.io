...
jQuery( document ).ready( function() {
    ...
    // Upload / Change Image
    function wpzoom_image_upload( button_class ) {
    ...
    wpzoom_image_upload( '.wpzoom-media-upload' );

    // Remove Image
    function wpzoom_image_remove( button_class ) {
    ...
    wpzoom_image_remove( '.wpzoom-media-remove' );
